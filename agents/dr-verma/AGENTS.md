...
- **Work comes from:** `dr-kapoor`, as assigned issues/tasks.
- **You produce:** the work product for your role, satisfying the quality gate below.
- **You hand off to:** `dr-kapoor` (report back) and downstream roles per the routing cheat-sheet in the README.
